...
<head>
    ...
    <title>A Very Nice Simple Board Game - SELT</title>
    ...
    <div class="container">
        ...
        <div class="game-container">
            <div class="game-header">
                <h1>A Very Nice Simple Board Game More</h1>
                <img src="../../boardgames/boardgamepicture1.png" alt="A Very Nice Simple Board Game More" class="game-image">
            </div>
            ...
            <div class="game-details">
                <div class="game-description">
                    ...
                    <p>
                        A Very Nice Simple Board Game More is an engaging educational board game designed to make learning fun and interactive. 
                        This game combines strategic thinking with language learning, helping students practice vocabulary, 
                        grammar, and communication skills in an enjoyable way.
                    </p>
                    <p>
                        Players take turns moving across the board, completing language challenges and activities as they 
                        progress. The game features multiple difficulty levels, making it suitable for different learning 
                        stages and abilities.
                    </p>
                    <p>
                        Whether you're a teacher looking for classroom activities or a student wanting to practice language 
                        skills, Board Game 1 offers an exciting and educational experience for all.
                    </p>
                </div>
                ...
                <div class="download-section">
                    ...
                    <a href="../../boardgames/A very nice simple board game.pdf" class="download-button" download>
