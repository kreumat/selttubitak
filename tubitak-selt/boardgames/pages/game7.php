    ...
    <div class="container">
        ...
        <div class="game-container">
            <div class="game-header">
                <h1>Board Game 7</h1>
                <img src="../../boardgames/boardgamepicture1.png" alt="Board Game 7" class="game-image">
            </div>
            ...
            <div class="game-details">
                <div class="game-description">
                    ...
                    <p>
                        Board Game 7 is a culturally-focused language learning game that promotes 
                        intercultural understanding and communication skills. This unique game combines 
                        language practice with cultural knowledge, helping learners develop a more 
                        comprehensive understanding of the target language.
                    </p>
                    <p>
                        Players navigate through different cultural scenarios, customs, and traditions 
                        from various regions where the target language is spoken. The game includes 
                        cultural trivia, situational role-plays, and discussion prompts that encourage 
                        exploration of cultural differences and similarities.
                    </p>
                    <p>
                        By integrating cultural elements with language practice, Board Game 7 helps 
                        learners develop not only linguistic competence but also cultural sensitivity 
                        and awareness. This game is particularly valuable for preparing students for 
                        real-world communication in diverse cultural contexts.
                    </p>
                </div>
