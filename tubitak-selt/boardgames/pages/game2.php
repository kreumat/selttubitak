...
<head>
    ...
    <title>Game of Many Faces - SELT</title>
    ...
    <div class="container">
        ...
        <div class="game-container">
            <div class="game-header">
                <h1>Game of Many Faces</h1>
                <img src="../../boardgames/boardgamepicture2.png" alt="Game of Many Faces" class="game-image">
            </div>
            ...
            <div class="game-details">
                <div class="game-description">
                    ...
                    <p>
                        Game of Many Faces is a dynamic language learning board game designed for students of all ages. 
                        This game focuses on vocabulary building, conversation practice, and critical thinking skills
                        through an exciting gameplay experience.
                    </p>
                    <p>
                        The game features a colorful board with various challenge spaces, encouraging players to 
                        engage in language activities such as describing objects, answering questions, and creating sentences.
                        The interactive nature of the game promotes peer learning and cooperation.
                    </p>
                    <p>
                        Board Game 2 is perfect for classroom activities, language centers, or home use. It's an effective
                        tool for making language practice enjoyable and memorable for students.
                    </p>
                </div>
                ...
                <div class="download-section">
                    ...
                    <a href="../../boardgames/Game of many faces.pdf" class="download-button" download>
