    ...
    <div class="container">
        ...
        <div class="game-container">
            <div class="game-header">
                <h1>Board Game 3</h1>
                <img src="../../boardgames/boardgamepicture1.png" alt="Board Game 3" class="game-image">
            </div>
            ...
            <div class="game-details">
                <div class="game-description">
                    ...
                    <p>
                        Board Game 3 is a creative language learning tool designed to improve reading comprehension 
                        and storytelling skills. This narrative-based game takes players on an adventure where each 
                        step requires completing a language challenge.
                    </p>
                    <p>
                        The game includes various story paths and scenarios, allowing for multiple gameplay experiences 
                        and replayability. Players must use their language skills to navigate through the story, making 
                        decisions that affect their journey's outcome.
                    </p>
                    <p>
                        This game is especially effective for developing reading skills, creative thinking, and narrative 
                        comprehension in an engaging and interactive format. It's suitable for both classroom use and 
