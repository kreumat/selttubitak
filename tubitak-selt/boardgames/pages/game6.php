    ...
    <div class="container">
        ...
        <div class="game-container">
            <div class="game-header">
                <h1>Board Game 6</h1>
                <img src="../../boardgames/boardgamepicture1.png" alt="Board Game 6" class="game-image">
            </div>
            ...
            <div class="game-details">
                <div class="game-description">
                    ...
                    <p>
                        Board Game 6 is a vocabulary-building game that helps learners expand their 
                        lexical knowledge in engaging and memorable ways. This game focuses on 
                        thematic vocabulary sets, word associations, and contextual understanding.
                    </p>
                    <p>
                        The game features various vocabulary challenges including word categorization, 
                        synonym/antonym matching, and word definition tasks. As players move through the 
                        board, they encounter different vocabulary themes and difficulty levels, making 
                        the game suitable for mixed-ability groups.
                    </p>
                    <p>
                        With colorful visuals and interactive gameplay, Board Game 6 transforms 
                        vocabulary acquisition from rote memorization into an enjoyable social activity. 
                        It's particularly effective for reinforcing new vocabulary and encouraging active 
