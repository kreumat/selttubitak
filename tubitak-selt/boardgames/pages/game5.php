    ...
    <div class="container">
        ...
        <div class="game-container">
            <div class="game-header">
                <h1>Board Game 5</h1>
                <img src="../../boardgames/boardgamepicture1.png" alt="Board Game 5" class="game-image">
            </div>
            ...
            <div class="game-details">
                <div class="game-description">
                    ...
                    <p>
                        Board Game 5 is designed specifically to develop listening comprehension skills 
                        in language learners. This innovative game combines audio cues with interactive 
                        gameplay to create an immersive learning experience.
                    </p>
                    <p>
                        Players advance by correctly responding to audio prompts, which can include 
                        questions, directions, or descriptions. The game includes various listening 
                        tasks such as identifying specific information, understanding main ideas, and 
                        following sequences of instructions.
                    </p>
                    <p>
                        This game is particularly effective for developing active listening skills and 
                        auditory processing abilities. It's designed to be adaptable for different 
                        proficiency levels and can be used in both classroom settings and individual practice.
                    </p>
                </div>
