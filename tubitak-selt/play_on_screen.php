...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="info-box">
            <h3>Game Pieces</h3>
            <p>Drag any of these pawns onto the game board to play. You can place them anywhere on the screen, and they will stay in position even when you scroll.</p>
            ...
            <p style="margin-top: 3rem;">Click and drag a pawn to place it on the board. The pawn will stay in place even when you scroll.</p>
            <p>You can use these pawns with any board game you upload.</p>
        </div>
        
        <!-- Middle panel - PDF Viewer -->
        <div class="container">
            <h1>Play on Screen</h1>
            <p class="instructions">Upload your PDF board game and play directly on your screen. Drag pawns from the left panel onto the board and use the dice roller on the right.</p>
        ...
        <div class="info-box team-info-box">
            <h3>Dice Roller</h3>
            <p>Click on the dice to roll it and get a random number from 1 to 6.</p>
            ...
            <h4>How to Play</h4>
            <ol>
                <li>Upload your PDF board game</li>
                <li>Drag pawns from the left panel onto the board</li>
                <li>Roll the dice to determine moves</li>
                <li>Move your pawns according to your game rules</li>
            </ol>
            
            <p>The pawns will stay in position even when you scroll up and down the page.</p>
        </div>
    </div>
